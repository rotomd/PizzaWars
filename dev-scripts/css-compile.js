/*
  ...
  node dev-scripts/css-compile.js
*/

var spawn = require('child_process').spawn,
  files = [
    {
      'in': '/dev-public/style/style.styl',
      'out': '/public/style'
    }    
  ],  
  abs_path = '',    
  get_path  = spawn('pwd', [], {stdio:'inherit'});
...
function run(file){
  file.process = spawn('stylus', [ abs_path + file['in'], '-o', abs_path + file['out'] ], { stdio: 'inherit' });
